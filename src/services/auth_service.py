...
from src.assets.file_paths.auth_paths import auth_path
from src.assets.questions.auth_questions import auth_questions
from src.assets.corrections.auth_fix import auth_fix
from src.assets.commands.auth_commands import auth_commands
